...
export default function DSGVO() {
  return (
    <div className="w-ful bg-[#131c2f] text-white px-[10rem] py-12">
      ...
      E-Mail-Adresse:{" "}
      <a href="mailto:conatct@encryptopia.dev">conatct@encryptopia.dev</a>
      Telefon: 4917648070041 Impressum:{" "}
      <a href="https://encryptopia.dev/impressum" target="_blank">
        https://encryptopia.dev/impressum
      </a>
      ...
      <p>
        ...
        tatsächlich erfolgt. Ändern sich z.&nbsp;B. die E-Mail-Adressen der
        Nutzer, müssen sie diese manuell in ihrem Nutzerkonto bei uns ändern.
      </p>
      <p>
      ...
      <p>Email Benachrichtigungen auf anfrage bei einem neuen Blog Post.</p>
      <ul className="m-elements">
        <li>
          <strong>Verarbeitete Datenarten:</strong> Bestandsdaten (z.&nbsp;B.
          Namen, Adressen); Kontaktdaten (z.&nbsp;B. E-Mail, Telefonnummern);
        ...
        <li>
          ...
          per E-Mail oder postalisch). Erbringung vertraglicher Leistungen und
      ...
      <ul className="m-elements">
        <li>
          ...
          auch Ihre IP-Adresse und der Zeitpunkt des Abrufs, erhoben. <br />
          <br />
        ...
        <li>
          ...
          zur Inanspruchnahme kostenloser Leistungen (z.&nbsp;.B. Zugang zu
          bestimmten Inhalten oder Teilnahme an bestimmten Aktionen) abhängig
          gemacht werden. Sofern die Nutzer die kostenlose Leistung in Anspruch
          nehmen möchten, ohne sich zum Newsletter anzumelden, bitten wir Sie um
