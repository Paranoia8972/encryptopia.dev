...
export function Comments() {
  ...
  useEffect(() => {
    const updateTheme = () => {
      ...
      script.setAttribute("data-repo", "Paranoia8972/encryptopia.dev");
      script.setAttribute("data-repo-id", "R_kgDOKXIhFA");
      script.setAttribute("data-category", "Blog");
      script.setAttribute("data-category-id", "DIC_kwDOKXIhFM4CjZCJ");
